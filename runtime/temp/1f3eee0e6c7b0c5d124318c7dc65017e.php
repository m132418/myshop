<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/default/cart\cart4.html";i:1490353006;s:44:"./template/pc/default/public\siteTopbar.html";i:1490353006;s:40:"./template/pc/default/public\footer.html";i:1490353006;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="orde-sjyy">
            ...
            <div class="bsjy-g">
            	<dl>
                    ...
                    <!--第三方网银支付 start-->
                      <?php if(is_array($bankCodeList) || $bankCodeList instanceof \think\Collection): if( count($bankCodeList)==0 ) : echo "" ;else: foreach($bankCodeList as $k=>$v): ?>
						<div class="order-payment-area">
                        	<div class="dsfzfpte">
