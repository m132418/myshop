<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./application/admin/view2/ad\ad.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="fixed-bar">
    ...
    <div class="ncap-form-default">
        ...
        <dd class="opt">
          <div id="gcategory">
            <select name="pid" class="input-sm" class="form-control">
                <?php if(is_array($position) || $position instanceof \think\Collection): $i = 0; $__LIST__ = $position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
	   ...
	   <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show" id="divComUploadContainer">
            ...
            <input type="button" class="type-file-button" onClick="GetUploadify(1,'ad_code','ad','')" value="上传图片"/>           
            </span>
          </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" placeholder="背景颜色：" class="input-txt" name="bgcolor" type="color" value="<?php echo $info['bgcolor']; ?>"  />
