<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/mobile/new/goods\goodsList.html";i:1490353004;s:44:"./template/mobile/new/public\footer_nav.html";i:1490353004;s:42:"./template/mobile/new/public\wx_share.html";i:1490353004;}*/ ?>
<html>
<head>
...
<section class="filtrate_term" id="product_sort" style="width: 100%;background:#FFF;">
		<ul>
        <li class="<?php if((\think\Request::instance()->param('sort') == '') or (\think\Request::instance()->param('sort') == 'is_new')): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/goodsList',array_merge($filter_param,array('sort'=>'is_new')),''));?>">最新</a></li>
		<li class="<?php if(\think\Request::instance()->param('sort') == 'sales_sum'): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/goodsList',array_merge($filter_param,array('sort'=>'sales_sum')),''));?>" >销量</a></li>
		<li class="<?php if(\think\Request::instance()->param('sort') == 'comment_count'): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/goodsList',array_merge($filter_param,array('sort'=>'comment_count')),''));?>">评论</a></li>
		<li class="<?php if(\think\Request::instance()->param('sort') == 'shop_price'): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/goodsList',array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>$sort_asc)),''));?>">价格<span class="arrow_up"></span><span class="arrow_down"></span></a></li>
...
//			data : $('#filter_form').serialize(),// 你的formid 搜索表单 序列化提交
        data:{id:'<?php echo \think\Request::instance()->param('id'); ?>',sort:'<?php echo \think\Request::instance()->param('sort'); ?>',sort_asc:'<?php echo \think\Request::instance()->param('sort_asc'); ?>',is_ajax:1,p:page},
