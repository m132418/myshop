<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/wechat\menu.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    ...
    <div class="bDiv" style="height: auto;">
      ...
      <table>
		 	<tbody id="tbody">
				<?php if(is_array($p_lists) || $p_lists instanceof \think\Collection): $i = 0; $__LIST__ = $p_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
			  	<tr data-id="<?php echo $list['id']; ?>" class="odd  pmenu<?php echo $list['id']; ?> menu<?php echo $list['id']; ?>">
			       ...
			       <!--父级操作-->
			       <?php if(is_array($c_lists) || $c_lists instanceof \think\Collection): $i = 0; $__LIST__ = $c_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clist): $mod = ($i % 2 );++$i;if($clist['pid'] == $list['id']): ?>
