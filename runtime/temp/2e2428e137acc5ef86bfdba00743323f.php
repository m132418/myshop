<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"./template/mobile/new/goods\categoryList.html";i:1490353004;s:44:"./template/mobile/new/public\footer_nav.html";i:1490353004;s:42:"./template/mobile/new/public\wx_share.html";i:1490353004;}*/ ?>
<!DOCTYPE html >
<html>
<head>
<meta charset="UTF-8">
  ...
  <div class="category-box">
    ...
    <?php $j = '0'; if(is_array($goods_category_tree) || $goods_category_tree instanceof \think\Collection): if( count($goods_category_tree)==0 ) : echo "" ;else: foreach($goods_category_tree as $kk=>$vo): ?>
          <dl style="margin-top:46px;padding-bottom:50px;<?php if($j == 0): ?>display:block;<?php else: ?>display:none;<?php endif; ?>" data-id="<?php echo $j++; ?>">
            ...
            <span>
              <?php $pid =400;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1491523200 and end_time > 1491523200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
