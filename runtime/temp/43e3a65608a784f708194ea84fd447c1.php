<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/system\basic.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" enctype="multipart/form-data" name="form1" action="<?php echo U('System/handle'); ?>">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^\d{1,}$" id="reg_integral" name="reg_integral" value="<?php echo $config['reg_integral']; ?>" class="input-txt" type="text">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^\d{1,}$" id="default_storage" name="default_storage" value="<?php echo $config['default_storage']; ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^\d{1,}$" name="warning_storage" value="<?php echo $config['warning_storage']; ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^\d{1,}$" name="need" id="distribut_need" value="<?php echo $config['need']; ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^\d{1,}$" name="min" id="distribut_min" value="<?php echo $config['min']; ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^(?!0+(?:\.0+)?$)(?:[1-9]\d*|0)(?:\.\d{1,2})?$" name="tax" id="tax" value="<?php echo $config['tax']; ?>" class="input-txt" type="text">%
