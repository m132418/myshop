<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/article\categoryList.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <tr nctype="0" <?php if($vo[parent_id] > 0): ?> style="display:none;"<?php endif; ?> class="parent_id_<?php echo $vo[parent_id]; ?>" data-level="<?php echo $vo[level]; ?>">
              ...
              <td class="name">
                <div style="text-align: left; width: 350px;">       
                  <input type="text" value="<?php echo $vo['name']; ?>"  onchange="changeTableVal('article_cat','cat_id',<?php echo $vo['cat_id']; ?>,'cat_name',this)"/>
                </div>
              </td>
              <td style="width: 100%;">
                <div>&nbsp;</div>
