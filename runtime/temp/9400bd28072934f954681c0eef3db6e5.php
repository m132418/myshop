<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"./application/admin/view2/comment\ajax_ask_list.html";i:1490352994;}*/ ?>
...
<table>
	...
	<?php else: if(is_array($comment_list) || $comment_list instanceof \think\Collection): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
