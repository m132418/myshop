<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./template/pc/default/user\login.html";i:1491472398;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="setout">
    <div class="login-area">
        ...
        <?php
                              ...
                              foreach($sql_result_v as $k=>$v): if($v['code'] == 'qq'): ?><span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'qq')); ?>"><i class="ba-po&#45;&#45;185"></i></a></span><?php endif; if($v['code'] == 'weixin'): ?><span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'weixin')); ?>"><i class="ba-po&#45;&#45;179-23"></i></a></span><?php endif; if($v['code'] == 'alipay'): ?><span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'alipay')); ?>"><i class="zhi-y-f"></i></a></span><?php endif; endforeach; ?>
