<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/order\add_order.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select id="shipping" name="shipping"  >
             <?php if(is_array($shipping_list) || $shipping_list instanceof \think\Collection): $i = 0; $__LIST__ = $shipping_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shipping): $mod = ($i % 2 );++$i;?>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select id="payment" name="payment"  >
               <?php if(is_array($payment_list) || $payment_list instanceof \think\Collection): $i = 0; $__LIST__ = $payment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$payment): $mod = ($i % 2 );++$i;?>
