<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/default/cart\cart2.html";i:1490353006;s:44:"./template/pc/default/public\siteTopbar.html";i:1490353006;s:40:"./template/pc/default/public\footer.html";i:1490353006;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
                        	...
                        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <?php if(is_array($cartList) || $cartList instanceof \think\Collection): if( count($cartList)==0 ) : echo "" ;else: foreach($cartList as $k=>$v): if($v[selected] == '1'): ?>
                                    <tr>
                                        ...
                                        <?php if(($user[discount] != 1)): ?>
                                        	<td class="tr-price te-al">¥<?php echo $v['member_goods_price']; ?></td>
                                        <?php endif; ?>
