<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/order\delivery_info.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
      ...
      <div class="tabs-panels">
        <div class="misc-info">
           <h3>基本信息</h3>
	              ...
	              <dl>
		            ...
		            <dt>配送单号</dt>
		            <dd><input class="input-txt" name="invoice_no" id="invoice_no" value="<?php echo $order['invoice_no']; ?>"></dd>
		            <dt></dt>
		            <dd></dd>
			       </dl>
        	</div>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <tbody>
            <?php if(is_array($delivery_record) || $delivery_record instanceof \think\Collection): $i = 0; $__LIST__ = $delivery_record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?>
	           	<tr>
