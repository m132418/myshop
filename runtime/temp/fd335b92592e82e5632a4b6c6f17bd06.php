<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/pickup\index.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<div class="sDiv">
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select name="province_id" id="province_id" onChange="get_city(this)">
							...
							<?php if(is_array($province) || $province instanceof \think\Collection): if( count($province)==0 ) : echo "" ;else: foreach($province as $k=>$v): ?>
