<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/pc/default/cart\ajax_address.html";i:1490353006;}*/ ?>
<?php if(is_array($address_list) || $address_list instanceof \think\Collection): if( count($address_list)==0 ) : echo "" ;else: foreach($address_list as $k=>$v): if($v[is_default] == 1): ?> <!--默认选中的地址-->
