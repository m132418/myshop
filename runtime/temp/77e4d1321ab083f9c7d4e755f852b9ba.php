<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"./application/admin/view2/goods\ajaxGoodsAttributeList.html";i:1490352994;}*/ ?>
<table>
       <tbody>
			<?php if(is_array($goodsAttributeList) || $goodsAttributeList instanceof \think\Collection): $i = 0; $__LIST__ = $goodsAttributeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
              <tr>
