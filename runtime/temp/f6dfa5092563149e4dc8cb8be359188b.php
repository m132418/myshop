<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"./application/admin/view2/pickup\ajaxPickupList.html";i:1490352994;}*/ ?>
<div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
    <table>
        <tbody>
        <?php if(is_array($pickupList) || $pickupList instanceof \think\Collection): $i = 0; $__LIST__ = $pickupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr>
                <td class="sign">
