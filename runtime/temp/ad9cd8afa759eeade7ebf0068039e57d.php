<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view2/goods\goodsAttributeList.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
      ...
      <div class="sDiv">
        <div class="sDiv2"> 
          <select name="type_id" id="type_id"  class="select">
                ...
                <?php if(is_array($goodsTypeList) || $goodsTypeList instanceof \think\Collection): if( count($goodsTypeList)==0 ) : echo "" ;else: foreach($goodsTypeList as $k=>$v): ?>
