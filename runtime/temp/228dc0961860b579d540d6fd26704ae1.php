<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/view2/order\ajax_return_list.html";i:1490352994;}*/ ?>
<table>
 	<tbody>
	...
	<?php else: if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?>
  	<tr>
        ...
        <td align="center" abbr="article_time" axis="col6" class="">
          <div style="text-align:left; width: 100px;" class="">
          		<?php if($items[status] == 0): ?>未处理<?php endif; if($items[status] == 1): ?>处理中<?php endif; if($items[status] == 2): ?>已完成<?php endif; ?> 
          </div>
        </td>
        <td align="center" abbr="article_time" axis="col6" class="">
