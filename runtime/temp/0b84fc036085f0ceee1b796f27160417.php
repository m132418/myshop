<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/promotion\flash_sale.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<div class="flexigrid">
		...
		<div class="bDiv" style="height: auto;">
			<div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
				<table>
					<tbody>
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							<td class="sign">
								<div style="width: 24px;"><i class="ico-check"></i></div>
							</td>
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn red" href="<?php echo U('Promotion/flash_sale_info',array('id'=>$vo['id'])); ?>"><i class="fa fa-pencil-square-o"></i>编辑</a>
