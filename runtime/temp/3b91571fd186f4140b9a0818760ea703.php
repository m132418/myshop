<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/order\order_log.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
      ...
      <div class="sDiv">
        ...
        <div class="sDiv2">	 
        	<select name="admin_id" >
				...
				<?php if(is_array($admin) || $admin instanceof \think\Collection): if( count($admin)==0 ) : echo "" ;else: foreach($admin as $key=>$vv): ?>
