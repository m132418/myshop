<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/tools\region.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
		...
		<div class="flexigrid">
			...
			<div class="bDiv" style="height: auto;">
				<div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
					<table>
						<tbody>
						<?php if(is_array($region) || $region instanceof \think\Collection): if( count($region)==0 ) : echo "" ;else: foreach($region as $k=>$vo): ?>
