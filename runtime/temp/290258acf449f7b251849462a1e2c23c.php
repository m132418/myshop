<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index\welcome.html";i:1491524980;}*/ ?>
<html>
<head>
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            ...
                            <tr>
                                ...
                                <td><a href="http://www.aa.cn/" target="_blank">商业授权</a></td>
                                <td class="gray_bg">官方论坛:</td>
                                <td><a href="http://www.aa.cn/articleList_cat_id_31.html" target="_blank">shop交流论坛</a></td>
                            </tr>
                            </tbody></table>
                    </div>
                </div>
...
<div id="footer" style="position: static; bottom: 0px;">
    <p>版权所有 © 2012-2017 深圳搜狐网络科技有限公司，并保留所有权利。</p>
</div>
