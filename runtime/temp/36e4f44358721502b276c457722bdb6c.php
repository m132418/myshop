<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./template/pc/default/payment\payment.html";i:1490353006;}*/ ?>
    	...
    	<div class="wihe-ee">
            ...
            <div class="fail-success">
            	<div class="fail-fasu">
                	支付完成
                    <br>
                    <a href="<?php echo U('Home/Cart/cart4',array('order_id'=>$order_id)); ?>">支付成功</a>
                </div>
            	...
            	<div class="success-fasu">
                	支付遇到问题
                    <br>
                    <a href="<?php echo U('Home/Cart/cart4',array('order_id'=>$order_id)); ?>">支付失败</a>
                </div>
            </div>
            <div class="re-qtzfgg">
            	<a href="<?php echo U('Home/Cart/cart4',array('order_id'=>$order_id)); ?>">返回选择其他支付方式</a>
            </div>
        </div>
    </div>
</body>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    location.href = "<?php echo U('Home/Cart/cart4',array('order_id'=>$order_id)); ?>";
                }
            }
        });
    }
