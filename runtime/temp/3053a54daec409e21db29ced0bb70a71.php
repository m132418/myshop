...
<div class="layout pa-to-10 fo-fa-ar">
    ...
    <div class="fr wi940">
        <div class="he50 wddd">
            ...
            <div class="fr">
                <div class="po-re zjs">
                    <ul>
                        <li id="q-s" class="fl cullent"><a href="<?php echo U('Home/User/coupon'); ?>"><span>未使用</span></a></li>
                        <li id="h-s" class="fl"><a href="<?php echo U('Home/User/coupon',array('type'=>1)); ?>"><span>已使用</span></a></li>
                        <li id="j-s" class="fl"><a href="<?php echo U('Home/User/coupon',array('type'=>2)); ?>"><span>已过期</span></a></li>
                    </ul>
 ...
 <?php if(empty($coupon_list)): ?><!--没查询到数据-->
                    ...
                    <div class="o-pro">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <?php if(is_array($coupon_list) || $coupon_list instanceof \think\Collection): $i = 0; $__LIST__ = $coupon_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coupon): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td class="col-pro-info te-al wi197"><p><?php echo $coupon['name']; ?></p></td>
                                    <td class="wi150"><span><?php echo (isset($coupon['code']) && ($coupon['code'] !== '')?$coupon['code']:'N'); ?></span></td>
                                    <td class="col-quty wi138"><?php echo $coupon['money']; ?></td>
                                    <td rowspan="1" class="col-pay wi252"><span><?php echo date('Y-m-d H:s',$coupon['use_end_time']); ?></span></td>
                                    <td rowspan="1" class="col-operate">
                                        <p class="p-link"><?php echo $coupon['condition']; ?></p>
                                    </td>
                                </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
